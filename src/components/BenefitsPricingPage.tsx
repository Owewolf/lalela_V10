...
import { ArrowLeft, Check, X, Star, Shield, Zap, BarChart3, Users, Store, Crown, CreditCard } from 'lucide-react';
...
export const BenefitsPricingPage: React.FC<BenefitsPricingPageProps> = ({ onBack, onUpgrade }) => {
  const benefits = [
    ...
    },
    {
      ...
      items: [
        ...
        "Control members, roles, and content",
        "Build and grow your own network"
      ]
    },
    {
      icon: BarChart3,
  ...
  const comparison = [
    ...
    { feature: "Create Community", free: "Trial only", licensed: true },
    { feature: "Ownership", free: false, licensed: true },
    { feature: "Access Duration", free: "Limited", licensed: "Lifetime" },
    { feature: "Advanced Analytics", free: false, licensed: true },
    { feature: "Priority Support", free: false, licensed: true },
  ];
    ...
    <div className="min-h-screen bg-surface pb-24">
      ...
      <div className="px-6 py-8 space-y-12 max-w-2xl mx-auto">
        ...
        <section className="text-center space-y-6">
          ...
          >
            ...
            <p className="text-on-surface-variant font-medium">
              Join communities for free, or unlock full control, ownership, and lifetime access with a once-off license.
            </p>
          </motion.div>
        ...
        <section className="relative">
          ...
          <div className="relative bg-surface-container-lowest p-8 rounded-[2.5rem] border border-emerald-500/20 shadow-xl space-y-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-lg font-bold text-primary">Lifetime Platform License</h3>
            ...
            <div className="space-y-4">
              <p className="text-sm font-bold text-on-surface">You get:</p>
              <div className="grid gap-3">
                {[
                  "Lifetime access to the Lalela platform",
                  "Create and own your own community",
                  "Full admin control over your community",
                  "Priority support",
                  "Advanced analytics",
        ...
        <section className="bg-surface-container-low p-8 rounded-[2.5rem] space-y-6">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-white/50 rounded-2xl border border-white space-y-2">
              <p className="text-sm font-bold text-on-surface">Platform License (R99) gives you:</p>
              <ul className="text-xs text-on-surface-variant font-medium space-y-1 list-disc pl-4">
                <li>Lifetime access to Lalela</li>
                <li>Ownership of your first community</li>
              </ul>
            </div>
            <div className="p-4 bg-white/50 rounded-2xl border border-white space-y-2">
              <p className="text-sm font-bold text-on-surface">Communities are licensed separately</p>
              <p className="text-xs text-on-surface-variant font-medium">Each new community requires its own license.</p>
            </div>
            <div className="grid grid-cols-2 gap-3">
              <div className="p-4 bg-white/50 rounded-2xl border border-white">
                ...
                <p className="text-xs font-bold text-on-surface">Unlimited communities (free or invited)</p>
              </div>
              <div className="p-4 bg-white/50 rounded-2xl border border-white">
                <p className="text-[10px] font-black text-outline uppercase tracking-widest mb-1">Ownership</p>
                <p className="text-xs font-bold text-on-surface">Multiple communities (each needs license)</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-8">
          <div className="text-center">
            <h3 className="text-2xl font-black text-primary">Benefits of Being Licensed</h3>
          </div>
        ...
        <section className="text-center p-10 bg-primary rounded-[3rem] text-white space-y-6 shadow-2xl shadow-primary/30">
          <div className="space-y-2">
            <h3 className="text-2xl font-black">Don’t Just Join Communities — Own Them</h3>
            <p className="text-sm text-white/80 font-medium">
              Start free, but unlock your full potential with a once-off license. Build, manage, and grow communities without limits.
            </p>
          </div>
          <button 
            onClick={onUpgrade}
          ...
          >
            Upgrade to Lifetime Access — R149
          </button>
        </section>
      </div>
    </div>
